...
### Übersicht über die IT-Services

| | | |
|-|-|-|
|Servicearten der IT | IT-Vertrieb | Beschaffung und Aufbau von Komponenten und IT-Systemen |
| | IT-Service | ermöglichter Service durch den Einsatz von/für IT |
| | Break/Fix-Support, Field Service, Vor-Ort-Service | Ausführung vor Ort, Kunden werden Arbeitszeit, Anfahrtskosten und Teile in Rechnung gestellt |
| | On-Side-Management | Übernahme von Dienstleistungen in den Räumen des Kunden |
| | Swap-Service | Austausch durch identisch aufgesetztes Gerät |
| | DIY-Service | Kunde darf Servicearbeiten an Produkten selbst durchführen, ohne dass Gewährleistungsansprüche verloren gehen | 
| | Cloud-Services | von Cloud-Providern angeboten |
| | Live-Chat | live Chat-Kontakt mit Mitarbeiter |
| | Chatbot | App, die mit KI in der Lage ist, mit Benutzern zu kommunizieren |
| | Managed Services | Dauerhafte, wiederkehrende IT-Service-leistungen eines Anbieters an einen Kunden; Art, Umfang, Qualität werden vom Dienstleister vorab in Service Level Agreement (SLA) festgelegt |
| | | Garantieservice | Unentgeltlicher Service aufgrund von Gewährleistungs- oder Garantieansprüchen |
| | Kulant | Freiwilliger unentgeltlicher Service | 
| | Helpdesk-Service | Service über Helpdesk |
| | Wartungsservice | Wartungsverträge |
| | Reparaturservice | Reparaturleistungen |
| | IT-Sourcing | externe Fremdbeschaffung von Dienstleistungen/Services; Strategie zur Auslagerung von Diensten |
| | IT-Outsourcing | Unbefristete Auslagerung umfangreicher IT-Aufgaben/Bereiche an externes Unternehmen in eigener Verantwortung mit Vertragsbindung |
| | IT-Einweisung | Einweisung von Kunden und Mitarbeitern |
| | IT-Training/Schulung | Angebot von Schulungen gegen Entgelt |
| Service-Verfügbarkeit | | 24/7 oder 12/5 |
| Servicedesk | | Servicestelle für Endnutzer |
| IT-Service-Management | | Gesamtheit der Aktivitäten, die von IT-Service-Provider/Anbieter durchgeführt werden, um Kunden angebotenen IT-Services zu planen, bereitzustellen, zu betreiben, zu steuern |
| Serviceportfolio/Servicekatalog | | Übersicht über angebotene Services, festgelegte Richtlinien, mit welchen Vereinbarungen der Service SMART beschrieben werden soll und werVerantwortlichkeiten für jeden Teil übernimmt |
| Service-Level-Management | | Kundenanforderungen in Dienstleistungsprodukten der IT-Organisation werden je nach Wichtigkeit/Priorität umgesetzt; Services geplant und vertraglich vereinbart |
| Key-Performance-Indikator | | Leistungsindikatoren sind Unterklasse von Metriken/Messgrößen, die auf kritische Geschäftsziele abgestimmt sind und Schlüsselstellung haben (Serviceverfügbarkeit, Anzahl der Serviceunterbrechungen) |
| Service-Oriented-Architecture | | Geschäftsprozesse und Systeme werden modularisiert und mittels Services verknpüft; komplexe Servicesysteme mit wiederverwendbaren Modulen können kostengünstiger/schneller entwickelt werden; dient der besseren Beschreibung der Integration von Systemen, Services und Unternehmensprozessen |
| Cloud-Plattformen von Providern | Infratstructure as a Service (IaaS) | grundlegende IT-Ressourcen wie Rechenleistung, Speicherlösungen, Netzwerkkapazitäten |
| | Function as a Service (FaaS) | vielfach verwendete Funktionen auf einfache Weise und leistungssteigernd/skalierbar |
| | Platform as a Service (PaaS) | auf Basis können eigene Softwareanwendungen entwickelt werden |
| | Software as a Service (SaaS) | Softwaredienste stehen on demand zur Verfügung |
...
**ISO 9000, ISO/IEC 27000, ISO/IEC 15504**
